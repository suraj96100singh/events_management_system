...
<body>
    <form action="hotelupdate.php?id=<?=$val['hotel_id'];?>" method='post'>
    ...
    <input type="text" class="form-control" placeholder="Hotel Name" name="hname" id="honame" required value="<?=$val['hname'];?>">
...
<div class="row">
  ...
  FlOOR <input  type="text" name="floreno[]" value="<?=$val['flore'];?>">

  ROOM NO <input  type="number"  name="roomno[]" value="<?=$val['room'];?>">
    ROOM CATEGORY <input  type="text"  name="roomcategory[]" value="<?=$val['roomcat'];?>">
...
<button class="btn btn-success mb-3 mt-5"> Update</button>
</div>
</form>
</body>
<script>
